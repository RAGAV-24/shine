...
const ResumeForm = ({ resumeData }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    navigate('/template-selection', { state: { formData } }); // Navigate to TemplateSelectionPage with formData
  };
  ...
  return (
    <form className="resume-form" onSubmit={handleSubmit}>
      ...
      <div className="form-group">
        ...
        <input type="text" name="ProgrammingLanguages" value={formData.ProgrammingLanguages.join(', ') || ''} onChange={handleChange} />
      </div>
      <div className="form-group">
        <label>Web Technologies</label>
        <input type="text" name="WebTechnologies" value={formData.WebTechnologies.join(', ') || ''} onChange={handleChange} />
      </div>
      <div className="form-group">
        <label>Tools and Frameworks</label>
        <input type="text" name="ToolsAndFrameworks" value={formData.ToolsAndFrameworks.join(', ') || ''} onChange={handleChange} />
      </div>
      <div className="form-group">
        <label>Databases</label>
        <input type="text" name="Databases" value={formData.Databases.join(', ') || ''} onChange={handleChange} />
      </div>
      <div className="form-group">
        <label>Hobbies</label>
        <input type="text" name="Hobbies" value={formData.Hobbies.join(', ') || ''} onChange={handleChange} />
      </div>
